...
class D14Test {
    final String sample = """
            ...
            #OO..#....
            """;
    final String input = Out.testResource("2023/D14.txt");

    @Test
    void sampleStar1() {
        Assertions.assertThat(new D14(sample).star1()).isEqualTo(136L);
    }

    @Test
    void sampleStar2() {
        Assertions.assertThat(new D14(sample).star2()).isEqualTo(64L);
    }

    @Test
    void star1() {
        Assertions.assertThat(new D14(input).star1()).isEqualTo(106186L);
    }

    @Test
    void star2() {
        Assertions.assertThat(new D14(input).star2()).isEqualTo(106390L);
    }
